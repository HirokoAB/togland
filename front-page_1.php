			...
			<div class="video_wrappar">
				...
				<div class="map_container">
						<div   class="map map_base">
							<img class="base_img" style="z-index:1;"src="<?php echo get_template_directory_uri(); ?>/img/map_base_2_2.svg" usemap="#_" alt="戸倉ネイチャーパークトップページに表示する地図のベース画像" />
						</div>
						...
						<div   class="map">
							<img class="" style="z-index:99;"src="<?php echo get_template_directory_uri(); ?>/img/map_index_1.svg" usemap="#tgitem" alt="戸倉ネイチャーパークトップページに表示する地図のベース画像" />
						</div>
