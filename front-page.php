		...
		<section>
			<div class="video_wrappar">
				...
				<div class="map_container">
						<div  type="image/svg+xml" style="z-index:" class="map map_base">
						...
						<div  type="image/svg+xml" style="z-index:" class="map map eagle shake">
							<img class=""src="<?php echo get_template_directory_uri(); ?>/img/map_eagle.svg" alt="戸倉ネイチャーパークトップページに表示しているサイトオオワシのイラスト">	
						</div>
						<div  type="image/svg+xml" style="z-index: " class="map keybox flash" id="">
